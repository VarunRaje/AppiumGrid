...
public class AppUtils {
	...
	public void setCapabilities(String device_name) {
	...
	//			AppUtils.NEW_COMMAND_TIMEOUT);
		capabilities.setCapability("appPackage", AppUtils.BASE_PKG);
		capabilities.setCapability("appActivity", AppUtils.APP_ACTIVITY);
		capabilities.setCapability("deviceName", device_name);
		capabilities.setCapability(CapabilityType.BROWSER_NAME, "");
	//	capabilities.setCapability(CapabilityType.VERSION, "6.0.1");
		capabilities.setCapability("platformName", "Android");
		capabilities.setCapability("app", new File(ClassLoader.getSystemResource(AppUtils.APPLICATION_NAME).getFile()).getAbsolutePath());
